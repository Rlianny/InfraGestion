...
namespace Infrastructure.Migrations
{
    ...
    {
        // ...existing code... (dejar solo una definición de la clase y métodos Up/Down)
        // Eliminar cualquier duplicado de métodos Up, Down, atributos o clases
        // Mantener solo la definición correcta
        // ...existing code...
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { -7, new DateTime(2025, 1, 18, 0, 0, 0, 0, DateTimeKind.Utc), -10, -21, new DateTime(2025, 1, 14, 0, 0, 0, 0, DateTimeKind.Utc), -18, true, 4, 1, -15, null, "Aprobado: daño estructural en unidad CRAC. Baja autorizada y retiro por logística.", -4 },
                    ...
                    { -3, new DateTime(2025, 3, 15, 0, 0, 0, 0, DateTimeKind.Utc), -5, null, new DateTime(2025, 3, 10, 0, 0, 0, 0, DateTimeKind.Utc), null, false, 3, 2, -16, null, "Rechazado: se requiere reevaluación, no se justifica baja con la evidencia presentada.", -2 },
                    { -2, null, -3, null, new DateTime(2025, 2, 5, 0, 0, 0, 0, DateTimeKind.Utc), null, null, 1, 0, -15, null, "", null },
                    { -1, new DateTime(2025, 1, 25, 0, 0, 0, 0, DateTimeKind.Utc), -4, -19, new DateTime(2025, 1, 20, 0, 0, 0, 0, DateTimeKind.Utc), -18, true, 4, 1, -14, null, "Daño físico severo: equipo fuera de servicio. Se autoriza baja y traslado a almacén general.", -1 }
                });
