...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20251215131320_UpdateSeed_20251215")]
    partial class UpdateSeed_20251215
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Aggregations.MaintenanceRecord", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            MaintenanceRecordId = -13,
                            Cost = 200.0,
                            Date = new DateTime(2025, 5, 10, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Reemplazo de disco y verificación RAID",
                            DeviceId = -2,
                            TechnicianId = -12,
                            Type = 1
                        },
                        new
                        {
                            MaintenanceRecordId = -14,
                            Cost = 75.0,
                            Date = new DateTime(2025, 6, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Ajuste de alineación de antena",
                            DeviceId = -5,
                            TechnicianId = -13,
                            Type = 0
                        },
                        new
                        {
                            MaintenanceRecordId = -15,
                            Cost = 130.0,
                            Date = new DateTime(2025, 6, 15, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Limpieza y reemplazo de módulos",
                            DeviceId = -7,
                            TechnicianId = -14,
                            Type = 0
                        },
                        new
                        {
                            MaintenanceRecordId = -16,
                            Cost = 210.0,
                            Date = new DateTime(2025, 7, 2, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Reparación de controladora SAN",
                            DeviceId = -9,
                            TechnicianId = -15,
                            Type = 1
                        },
                        new
                        {
                            MaintenanceRecordId = -17,
                            Cost = 55.0,
                            Date = new DateTime(2025, 7, 20, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Calibración de OTDR",
                            DeviceId = -11,
                            TechnicianId = -16,
                            Type = 0
                        },
                        new
                        {
                            MaintenanceRecordId = -18,
                            Cost = 90.0,
                            Date = new DateTime(2025, 8, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Chequeo de sondeo de paquetes",
                            DeviceId = -16,
                            TechnicianId = -12,
                            Type = 0
                        },
                        new
                        {
                            MaintenanceRecordId = -19,
                            Cost = 300.0,
                            Date = new DateTime(2025, 8, 18, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Reemplazo de fuente y test de rendimiento",
                            DeviceId = -18,
                            TechnicianId = -13,
                            Type = 1
                        },
                        new
                        {
                            MaintenanceRecordId = -20,
                            Cost = 110.0,
                            Date = new DateTime(2025, 9, 5, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Actualización de firmware de switch",
                            DeviceId = -24,
                            TechnicianId = -14,
                            Type = 0
                        },
                        new
                        {
                            MaintenanceRecordId = -21,
                            Cost = 160.0,
                            Date = new DateTime(2025, 9, 20, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Problemas en snapshot de backup",
                            DeviceId = -25,
                            TechnicianId = -15,
                            Type = 1
                        },
                        new
                        {
                            MaintenanceRecordId = -22,
                            Cost = 45.0,
                            Date = new DateTime(2025, 10, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Verificación de enlace inalámbrico",
                            DeviceId = -27,
                            TechnicianId = -16,
                            Type = 0
                        });
            ...
            modelBuilder.Entity("Domain.Aggregations.ReceivingInspectionRequest", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            AcceptedDate = new DateTime(2025, 1, 13, 0, 0, 0, 0, DateTimeKind.Utc),
                            AdministratorId = -5,
                            DeviceId = -10,
                        ...
                        new
                        {
                            ...
                            AcceptedDate = new DateTime(2025, 1, 24, 0, 0, 0, 0, DateTimeKind.Utc),
                            AdministratorId = -1,
                            DeviceId = -21,
                        ...
                        new
                        {
                            ...
                            AcceptedDate = new DateTime(2025, 1, 26, 0, 0, 0, 0, DateTimeKind.Utc),
                            AdministratorId = -3,
                            DeviceId = -23,
